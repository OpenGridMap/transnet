...
./prepare_continent_poly_and_voltages.sh ../configs/continents/australiaoceania.conf
./prepare_continent_poly_and_voltages.sh ../configs/continents/centralamerica.conf
